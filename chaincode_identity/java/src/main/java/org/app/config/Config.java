...
public class Config {
	...
	public static final String ORG1_PEER_2_URL = "grpc://localhost:8051";
	
	public static final String ORG1_PEER_3 = "peer3.org1.example.com";
	
	public static final String ORG1_PEER_3_URL = "grpc://localhost:8056";

	public static final String ORG1_PEER_4 = "peer4.org1.example.com";
	
	public static final String ORG1_PEER_4_URL = "grpc://localhost:9051";
